...
export default function BottomNavBar({
  ...
  const tabs = [
    ...
    { key: "admin", label: "Admin", icon: "diversity_1", path: "/admin" },
    {
      key: "profile",
      label: "Profile",
      icon: "account_circle",
      ...
      {tabs.map((tab) => {
        ...
        return (
          <button
            ...
            className={`flex flex-col items-center justify-center rounded-full px-5 py-1 active:scale-90 transition-all ${
              isActive
